...
<!DOCTYPE html>
<head>
	<link rel="stylesheet" type="text/css" href="/resources/css/small-common.css">
</head>
<body>
	<!-- 로딩 페이지 -->
	<div id="load">
	...
	<!-- // 로딩페이지 -->
	<header>
		<nav class="navbar text-color" style="background-color: #4457c0f7;">
			<div class="container-fluid">
				<div class="navbar-header">
					<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
						<i class="fas fa-bars"></i>
					</button>
					<a class="navbar-brand" href="/index">TIS.EDU Project</a>
				</div>
					...
					<ul class="nav navbar-nav navbar-right">
						<c:choose>
							...
							<c:when test="${sessionScope.userInfo.authority eq 'ROLE_USER'}">
								<li><b><c:out value="${sessionScope.userid}"/></b>님</li>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
                	<a type="button" id="btn-sign" onclick="location.href='/findUserID'">아이디 찾기</a>
                	<span>&#124;</span>
                	<a type="button" id="btn-sign" onclick="location.href='/findUserPW'">비밀번호 찾기</a>
                	<span>&#124;</span>
